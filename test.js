...
app.post('/', function (req, res) {
    ...
    console.log('print Direct',req.body.node_direct)
...
//   console.log(print)
  ...
  print.print("out.pdf",{printDialog:req.body.node_direct == 0,paperSize:'A6'}).catch((error)=>console.log(error)).then(console.log);
